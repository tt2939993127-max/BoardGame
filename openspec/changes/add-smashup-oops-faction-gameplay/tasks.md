...
- [ ] 4.4 完成 `Cowboys` 专项规则审计，覆盖 duel / destroy / move / hand-size 判定与共享链路扩审
- [ ] 4.5 为 `Cowboys` 补领域测试与派系 evidence，必要时补最小 E2E 证据
...
- [ ] 5.4 完成 `Samurai` 专项规则审计，覆盖 replacement / reactive move / destroy 链路与共享链路扩审
- [ ] 5.5 为 `Samurai` 补领域测试与派系 evidence，必要时补最小 E2E 证据

## 6. Cross-faction Audit Rollup & Verification
- [ ] 6.1 四个派系全部完成后，汇总四份派系审计结果，复查共享链路与跨派系交互回归
