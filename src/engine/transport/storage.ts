 ...
 * 存储层接口定义
 *
 * 替代 boardgame.io 的 StorageAPI，提供项目自有的存储抽象。
 * MongoStorage / HybridStorage 将适配此接口。
 */

// ============================================================================
// 元数据类型（替代 boardgame.io Server.MatchData）
// ============================================================================
...
// ============================================================================
// 存储状态类型（替代 boardgame.io State）
// ============================================================================

/**
 * 存储中的对局状态
 *
 * boardgame.io 的 State 包含 { G, ctx, plugins, _stateID, ... }。
 * 我们只需要 G（即 MatchState<TCore>）和一个递增版本号。
 */
