...
const ROLE_CARDS: Array<{
...
}> = [
    {
        role: 'user',
        label: '普通用户',
        description: '无后台权限，只能作为普通平台用户使用。',
        icon: UserIcon,
    ...
    },
    {
        role: 'developer',
        label: '开发者',
        description: '只能进入更新日志后台，并且只能管理勾选游戏的更新日志。',
        icon: ScrollText,
    ...
    },
    {
        role: 'admin',
        label: '管理员',
        description: '主管理角色，拥有完整后台权限，也可以继续授权其他用户为管理员。',
        icon: Shield,
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className={cn('mt-1 text-xs leading-5', active ? 'text-white/85' : 'text-zinc-500')}>
                                            {card.description}
                                        </p>
                                    </div>
                                </button>
                    ...
                    {roleDraft === 'developer' && (
                        <div className="rounded-2xl border border-amber-100 bg-amber-50/60 px-4 py-4">
                            <div className="flex items-start justify-between gap-3">
                                <div>
                                    <p className="text-sm font-semibold text-amber-900">开发者可管理游戏</p>
                                    <p className="mt-1 text-xs leading-5 text-amber-800/80">
                                        开发者只能管理这里勾选游戏的更新日志，不能越权修改其他游戏。
                                    </p>
                                </div>
