...
export default function AIRepoWorkbench() {
    ...
    return (
        <div data-testid="workbench-surface" className="min-h-screen bg-[linear-gradient(180deg,#f6f1e7_0%,#efe4d4_45%,#f9f6ef_100%)] text-stone-900">
            <div className="mx-auto w-full max-w-[1720px] px-4 py-4 sm:px-6 xl:px-8">
                <div className="flex flex-wrap items-center justify-between gap-4 rounded-[24px] border border-white/70 bg-white/80 px-5 py-3 shadow-[0_14px_36px_rgba(120,53,15,0.05)] backdrop-blur-sm">
                    <div className="min-w-0">
                        <p className="text-xs font-semibold uppercase tracking-[0.32em] text-stone-500">AI Repo Workbench</p>
                        <div className="mt-1 flex flex-wrap items-center gap-3">
                            <h1 data-testid="workbench-page-heading" className="text-[28px] font-semibold tracking-tight text-stone-950">AI 仓库工作台</h1>
                            <StatusBadge status={activeRun?.status ?? 'pending'} />
                        </div>
                        <p className="mt-1 max-w-5xl text-sm leading-6 text-stone-600">
                            以 16:9 桌面基线组织：左侧上下文与模板，中间主流程区，右侧决策 / 产物 inspector。
                        </p>
                    </div>
                    <button
                        type="button"
