...
export const GameHUD = ({
    ...
    return (
        ...
        >
            ...
            {/* Undo Section - only show during game */}
            {showUndo && undoStatus && undoState && (
                <div className="pt-2 pb-2 border-t border-white/10">
                    ...
                    {undoStatus === 'isRequester' && (
                        <div className="space-y-2">
                            ...
                            <button
                                onClick={() => undoState.moves[UNDO_COMMANDS.CANCEL_UNDO]()}
                                className="w-full px-3 py-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white/80 text-xs font-medium transition-all"
                            >
                    ...
                    {undoStatus === 'canRequest' && (
                        <button
                            onClick={() => undoState.moves[UNDO_COMMANDS.REQUEST_UNDO]()}
                            className="w-full px-3 py-2.5 rounded-lg bg-amber-500/20 hover:bg-amber-500 hover:text-black border border-amber-500/50 hover:border-amber-500 text-amber-400 font-bold text-xs transition-all group"
                        >
