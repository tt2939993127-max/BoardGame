    ...
    return (
        <aside
            ...
            className={`${embedded
                ...
                : 'pointer-events-auto fixed left-4 top-4 z-[2100] flex max-h-[calc(100vh-2rem)] w-[min(320px,calc(100vw-2rem))] flex-col overflow-hidden rounded-[20px] border border-white/12 bg-[#130d09]/94 shadow-[0_24px_80px_rgba(0,0,0,0.45)] backdrop-blur-md'}`}
