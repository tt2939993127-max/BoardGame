...
export const PlayerStats = ({
    ...
    return (
        <div className="flex flex-col gap-[0.8vw] w-full bg-slate-900/80 p-[0.8vw] rounded-[0.8vw] border border-slate-600/50 shadow-xl backdrop-blur-md z-20 hover:bg-slate-900 transition-[background-color] duration-200">
            <div ref={hpRef} className="relative w-full h-[1.8vw] bg-black/50 rounded-full border border-white/10 overflow-hidden group/hp">
                <div
                    className="absolute top-0 bottom-0 left-0 bg-gradient-to-r from-red-900 to-red-600 transition-[width] duration-500 ease-out"
            ...
            <div className="relative w-full h-[1.8vw] bg-black/50 rounded-full border border-white/10 overflow-hidden group/cp">
                <div
                    className="absolute top-0 bottom-0 left-0 bg-gradient-to-r from-amber-800 to-amber-500 transition-[width] duration-500 ease-out"
