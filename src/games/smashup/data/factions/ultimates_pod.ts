...
export const ULTIMATES_POD_CARDS: CardDef[] = [
    ...
    { id: 'ultimates_lift_and_carry_pod', type: 'action', subtype: 'standard', name: '搬运', nameEn: 'Lift and Carry', faction: FACTION, abilityTags: ['onPlay'], playNeedsMinion: true, playTargetMinionController: 'any', count: 1, previewRef: { type: 'atlas', atlasId: ATLAS, index: 51 } },
