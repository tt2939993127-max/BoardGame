...
const APPROVED_GENERIC_SOURCE_REASONS: Record<string, string> = {
    ...
    cowboys_gold_in_them_thar_hills: '候选项来自牌库顶静态卡面与分支结果，不对应当前棋盘实体。',
    cowboys_gold_in_them_thar_hills_order: '这是展示后剩余牌的排序交互，保留 generic 更准确。',
    ...
    vikings_cast_the_runes_order: '这是展示牌库顶后重排顺序的静态快照交互，不对应当前棋盘实体。',
    ...
    vikings_raiding_party_choice: '这是展示牌库顶后选择是否额外打出的静态快照交互，不对应当前棋盘实体。',
