                ...
                {savedDecks.length > 0 && (
                    <div className="pt-2 border-t border-white/5">
                        ...
                        <div className="space-y-1 max-h-[80px] overflow-y-auto">
                            {savedDecks.map(deck => (
                                <div key={deck.id} className="flex items-center justify-between group text-xs text-white/70 hover:bg-white/5 px-2 py-1 rounded cursor-pointer" onClick={() => onLoad(deck.id)}>
                                    ...
                                    <button
                                        ...
                                        className="text-white/20 hover:text-red-400 opacity-0 group-hover:opacity-100 flex-shrink-0 ml-2"
                                    >
                                        ✕
                                    </button>
                                </div>
