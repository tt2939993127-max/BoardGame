...
ASSET_PUBLISH_ALLOW_UNAUTHENTICATED="${ASSET_PUBLISH_ALLOW_UNAUTHENTICATED:-0}"
...
BG_ASSET_PUBLISH_MAX_UPLOAD_BYTES=21474836480
BG_ASSET_PUBLISH_MAX_CHUNK_BYTES=8388608
BG_ASSET_PUBLISH_MAX_SESSIONS=4
BG_ASSET_PUBLISH_SESSION_TTL_SECONDS=3600
BG_ASSET_PUBLISH_MAX_SOURCE_BYTES=2147483648
BG_ASSET_PUBLISH_SOURCE_WINDOW_SECONDS=86400
BG_ASSET_PUBLISH_ALLOW_UNAUTHENTICATED=${ASSET_PUBLISH_ALLOW_UNAUTHENTICATED}
