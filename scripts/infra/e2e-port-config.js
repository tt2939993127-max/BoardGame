...
export const E2E_SINGLE_WORKER_PORTS = Object.freeze({
  frontend: resolvePort(process.env.PW_E2E_FRONTEND_PORT, 6173),
  gameServer: resolvePort(process.env.PW_E2E_GAME_SERVER_PORT, 20000),
  apiServer: resolvePort(process.env.PW_E2E_API_SERVER_PORT, 21000),
});
