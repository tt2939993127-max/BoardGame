...
- 设计配色、组件、动效、游戏 HUD/牌桌/面板：读项目 [`ui-design-pipeline`](../../skills/ui-design-pipeline/SKILL.md)、[`ui-ux-pro-max`](../../skills/ui-ux-pro-max/SKILL.md)，并读 [`ui-change-gates`](../standards/ui-change-gates.md) 和 [`ui-ux`](../standards/ui-ux.md)。
...
- 新游戏位图设计稿、设计批准门禁：读项目 [`ui-design-pipeline`](../../skills/ui-design-pipeline/SKILL.md)、项目 [`boardgame-ui-imagegen`](../../skills/boardgame-ui-imagegen/SKILL.md)、[`create-new-game`](../../skills/create-new-game/SKILL.md)。
...
- 设计前置证据、素材输入链或设计流程失守回代：读项目 [`ui-design-pipeline`](../../skills/ui-design-pipeline/SKILL.md)、项目 [`boardgame-ui-imagegen`](../../skills/boardgame-ui-imagegen/SKILL.md) 和项目 [`skill-governance`](../../skills/skill-governance/SKILL.md)。
...
- 大规模 UI 改动：先读项目 [`ui-design-pipeline`](../../skills/ui-design-pipeline/SKILL.md) 与 [`ui-ux-pro-max`](../../skills/ui-ux-pro-max/SKILL.md) 的 `--design-system`，再读取 `design-system/` 对应家族。
- 游戏 UI 风格选择：读 `design-system/styles/`；实施状态横幅：读 [`frontend 实施状态`](../../../docs/framework/frontend.md) § 实施中状态横幅。

## 截图、图片与教程交付

- E2E 截图、AI 图面验收或截图交付：先读 [`e2e-verification`](../standards/e2e-verification.md) 取得证据资格；用户看图、项目开图脚本、证据目录和相册规则统一读项目 [`show-image-to-user`](../../skills/show-image-to-user/SKILL.md)。
- 用户明确说“打开图片/图呢/给我看图”：第一入口固定是项目 [`show-image-to-user`](../../skills/show-image-to-user/SKILL.md)；该副本包含本项目实际采用的通用开图规则和 BoardGame 适配。
...
- UI 审计、玩家视角验收、截图不通过后继续重构：读项目 [`ui-audit-loop`](../../skills/ui-audit-loop/SKILL.md)、[`ui-change-gates`](../standards/ui-change-gates.md)、[`ui-ux`](../standards/ui-ux.md)。
