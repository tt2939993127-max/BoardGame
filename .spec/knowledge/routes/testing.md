...
- E2E 交互、真实入口和截图证据：先读 [`e2e-verification`](../standards/e2e-verification.md)；需要用户看到图片时读系统 [`show-image-to-user`](D:/codex-home/skills/show-image-to-user/SKILL.md)，需要项目开图脚本、证据目录或相册约定时再读项目 [`screenshot-delivery`](../../skills/screenshot-delivery/SKILL.md)。
