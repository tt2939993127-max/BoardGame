...
- E2E 交互、真实入口和截图证据：先读 [`e2e-verification`](../standards/e2e-verification.md)；用户看图、项目开图脚本、证据目录和相册约定统一读项目 [`show-image-to-user`](../../skills/show-image-to-user/SKILL.md)。
...
- UI 审计不能只用 E2E 绿灯收口：转 [`UI 与截图交付`](ui.md)，补读项目 [`ui-audit-loop`](../../skills/ui-audit-loop/SKILL.md) 和 [`ui-change-gates`](../standards/ui-change-gates.md)。
