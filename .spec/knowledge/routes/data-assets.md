...
- 参考图生成 Three.js/img2threejs 程序化模型：先读项目 [`img2threejs-readiness`](../../skills/img2threejs-readiness/SKILL.md)，再读项目 [`img2threejs-reconstruction`](../../skills/img2threejs-reconstruction/SKILL.md) 和 [`asset-pipeline`](../standards/asset-pipeline.md)。
...
- 挑选、查找、试听、对接或补预加载音效：读项目 [`audio-integration`](../../skills/audio-integration/SKILL.md)、[`audio-assets`](../standards/audio-assets.md) 和 `docs/audio/audio-usage.md`。
- 从外部导入音频素材：读项目 [`audio-integration`](../../skills/audio-integration/SKILL.md)、[`audio-assets`](../standards/audio-assets.md) 和 `docs/audio/add-audio.md`。
...
- 配置表审查、字段核对、旧游戏 adapter 或修正提案：读项目 [`config-review-workflow`](../../skills/config-review-workflow/SKILL.md)、[`game-config-package`](../standards/game-config-package.md) 和项目 [`data-entry-workflow`](../../skills/data-entry-workflow/SKILL.md)。
