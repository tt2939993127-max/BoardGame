...
| 只改 UI、交互入口、提示、布局、截图证据                   | .spec/knowledge/standards/ui-change-gates.md + .spec/knowledge/standards/e2e-verification.md | 项目 ui-audit-loop；用户开图、项目证据目录、脚本和相册约定统一读项目 show-image-to-user |
