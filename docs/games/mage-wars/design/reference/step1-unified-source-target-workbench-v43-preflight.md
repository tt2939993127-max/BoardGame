# Mage Wars 统一来源目标工作台 v43 出图前硬回执
...
| 目标入口 / 环境 | Open Design artifact：`D:\codex-home\tools\open-design\.od\projects\mage-wars-ui-design\mage-wars-step1-unified-source-target-workbench-v43.html`；`mediaGenerate=false` |
