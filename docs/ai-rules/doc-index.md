...
| **乐观更新/延迟优化** (optimistic/latency/预测) | `docs/ai-rules/engine-systems.md` § 乐观更新引擎 | Random Probe 自动检测、AnimationMode、AnimationDelay（乐观状态延迟渲染）、EventStream 水位线、pending replay、`latencyConfig.ts` |
