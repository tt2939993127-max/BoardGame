...
- Bug 分析：`evidence/smashup/plateau-leng-implementation-bug.md`
- 实现历史：`evidence/smashup/plateau-leng-implementation-history.md`
- 原始修复：`evidence/smashup/plateau-locals-fix-complete.md`
