...
1. **读取 P0 审计报告**
   ```bash
   cat evidence/_shared/p0-audit-final-complete.md
   ```
...
- `evidence/_shared/audit-final-status.md` - 审计最终状态报告
- `evidence/dicethrone/audit-methodology.md` - 审计方法论
- `evidence/_shared/p0-audit-final-complete.md` - P0 审计报告
- `evidence/_shared/p1-verification-complete.md` - P1 验证报告
