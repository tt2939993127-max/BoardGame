...
`D:\gongzuo\webgame\BoardGame-wt-dicethrone-gunslinger-samurai\test-results\evidence-screenshots\dicethrone\dicethrone-simple-start.e2e\Online-match-Gunslinger-can-be-selected-and-start-a-game-successfully\Online-match-Gunslinger-can-be-selected-and-start-a-game-successfully-gunslinger-selection.png`
...
`D:\gongzuo\webgame\BoardGame-wt-dicethrone-gunslinger-samurai\test-results\evidence-screenshots\dicethrone\dicethrone-simple-start.e2e\Online-match-Gunslinger-can-be-selected-and-start-a-game-successfully\Online-match-Gunslinger-can-be-selected-and-start-a-game-successfully-gunslinger-game-started.png`
