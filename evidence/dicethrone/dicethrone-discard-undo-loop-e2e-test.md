...
- 运行命令：
pm run test:e2e:ci:file -- e2e/dicethrone/dicethrone-simple-start.e2e.ts "Online DiceThrone 弃牌超限时应可正常弃到手牌上限并自动推进下一回合（避免弃牌/撤回循环卡死）"
...
- 观察：左侧阶段栏高亮在“7.弃牌阶段”，底部手牌区可见多张手牌且出现“弃牌阶段/请选择弃置”的提示文案，符合弃牌超限前置场景。
...
- 观察：阶段栏切换到“3.主要阶段(1)”，画面中央出现“正在思考中”，表明已进入对手回合；弃牌阶段高亮不再存在。
