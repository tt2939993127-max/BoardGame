...
- 系统 skill `D:\codex-home\skills\audio-integration\SKILL.md`（workflow） + `docs/ai-rules/audio-assets.md`（运行时主合同）+ `docs/audio/audio-usage.md`（项目接入合同；新增音频资产流程见 `docs/audio/add-audio.md`）
