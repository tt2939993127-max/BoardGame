...
- 图片文字读取、OCR、卡图/房间图规则录入或读图卡死：`.codex/skill/safe-image-reading/SKILL.md`
- 图片资源路径、manifest、服务器素材主源：`docs/ai-rules/asset-pipeline.md`
- 机制实现承接：`docs/ai-rules/engine-systems.md`
- 不确定入口：`docs/ai-rules/doc-index.md`
...
- **禁止误路由**
  - Smash Up 新派系任务不是“新增游戏”，默认不要改走 `.codex/skill/create-new-game/SKILL.md`。
...
- 若还没有专用 workflow：以 `docs/ai-rules/data-entry.md` 为主流程，再补读该游戏自己的 `src/games/<gameId>/rule/` 文档。
