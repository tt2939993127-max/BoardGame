...
> 权威细节请以 `docs/ai-rules/testing-audit-dimensions.md` 为准。
> 本文件仅用于快速索引与提醒，审计时**必须打开权威文档**逐条检查。

## 使用要求（强制）
1. 审计时必须打开 `docs/ai-rules/testing-audit-dimensions.md`。
...
- 完整维度清单、D1-D58 定义、维度选择指南和输出格式只看 `docs/ai-rules/testing-audit-dimensions.md`。
